import { ArrayNumber4, TgdMaterial, TgdVec3, TgdVec4 } from "@tolokoban/tgd"
...
export class Material extends TgdMaterial {
    ...
    constructor(options: MaterialOptions) {
        super({
            ...
            vertexShaderCode: () => [`varNormal = ${this.attNormal};`],
            ...
            extraFragmentShaderFunctions: () => ({
                ...
                getColor3D: [
                    ...
                    [
                        ...
                        "light *= .5;",
                        `vec4 color = uniColor3D;`,
                        `vec3 reflection = mat3(uniModelViewMatrix) * reflect(uniLightDir, normal);`,
